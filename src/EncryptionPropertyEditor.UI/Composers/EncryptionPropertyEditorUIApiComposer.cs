...
using Umbraco.Community.EncryptionPropertyEditor;

namespace EncryptionPropertyEditor.UI.Composers
{
    public class EncryptionPropertyEditorUIApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Encryption Property Editor UIBackoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<EncryptionPropertyEditorUIOperationSecurityFilter>();
            });
        }

        public class EncryptionPropertyEditorUIOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Umbraco.Community.EncryptionPropertyEditor.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
